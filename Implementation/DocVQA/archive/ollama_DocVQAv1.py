...
def calculate_vqa_metrics(predicted_answer: str, ground_truth_answers: list[str]):
    ...
    # FIX: Ensure ground_truth_answers is an iterable list, even if it's None
    ...
    # Exact Match (EM)
    em_score = 1.0 if normalized_pred in normalized_gts and normalized_pred != "" else 0.0 # Also ensure non-empty match
    ...
    if not normalized_pred and not normalized_gts: # Both empty, perfect match
        ...
        for gt in normalized_gts:
            ...
            if len_pred == 0 and len_gt == 0:
                ...
                # Normalize Levenshtein distance to similarity (0 to 1)
